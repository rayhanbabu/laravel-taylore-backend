...
@section('content')
      ...
      <div class="row mt-3 mb-0 mx-2">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Back details View </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="back_name" style="cursor: pointer">Back Details Name 
                <span id="back_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               <label for="roll">Back  Name<span style="color:red;"> * </span></label>
               <input type="text" name="back_name" id="back_name" class="form-control" placeholder="" required>
               <p class="text-danger error_back_name"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="back_des" id="back_des" class="form-control" placeholder="" >
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
               <label for="roll">Back details Name<span style="color:red;"> * </span></label>
               <input type="text" name="back_name" id="edit_back_name" class="form-control" placeholder="" required>
               <p class="text-danger error_back_name"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="back_des" id="edit_back_des" class="form-control" placeholder="" >
                <p class="text-danger error_designation"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Back Status</b></label>
                    <select class="form-select" name="back_status" id="edit_back_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/admin/backdetail_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_back_name").val(response.data.back_name);
              $("#edit_back_des").val(response.data.back_des);
              $("#edit_back_status").val(response.data.back_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/backdetail/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },

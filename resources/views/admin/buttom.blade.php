...
@section('buttom','active')
@section('content')

      <div class="row mt-3 mb-0 mx-2">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Buttom View </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="buttom_name" style="cursor: pointer">buttom Name 
                <span id="buttom_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               <label for="roll">Buttom  Name<span style="color:red;"> * </span></label>
               <input type="text" name="buttom_name" id="buttom_name" class="form-control" placeholder="" required>
               <p class="text-danger error_buttom_name"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="buttom_des" id="buttom_des" class="form-control" placeholder="" >
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
               <label for="roll">Buttom  Name<span style="color:red;"> * </span></label>
               <input type="text" name="buttom_name" id="edit_buttom_name" class="form-control" placeholder="" required>
               <p class="text-danger error_buttom_name"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="buttom_des" id="edit_buttom_des" class="form-control" placeholder="" >
                <p class="text-danger error_designation"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>buttom Status</b></label>
                    <select class="form-select" name="buttom_status" id="edit_buttom_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/admin/buttom_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_buttom_name").val(response.data.buttom_name);
              $("#edit_buttom_des").val(response.data.buttom_des);
              $("#edit_buttom_status").val(response.data.buttom_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/buttom/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },

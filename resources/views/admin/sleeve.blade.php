...
@section('sleeve','active')
@section('content')

      <div class="row mt-3 mb-0 mx-2">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Sleeve View </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="sleeve_name" style="cursor: pointer">Sleeve Name 
                <span id="sleeve_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               <label for="roll">Sleeve  Name<span style="color:red;"> * </span></label>
               <input type="text" name="sleeve_name" id="sleeve_name" class="form-control" placeholder="" required>
               <p class="text-danger error_sleeve_name"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="sleeve_des" id="sleeve_des" class="form-control" placeholder="" >
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
               <label for="roll">Sleeve  Name<span style="color:red;"> * </span></label>
               <input type="text" name="sleeve_name" id="edit_sleeve_name" class="form-control" placeholder="" required>
               <p class="text-danger error_sleeve_name"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="sleeve_des" id="edit_sleeve_des" class="form-control" placeholder="" >
                <p class="text-danger error_designation"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Sleeve Status</b></label>
                    <select class="form-select" name="sleeve_status" id="edit_sleeve_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/admin/sleeve_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_sleeve_name").val(response.data.sleeve_name);
              $("#edit_sleeve_des").val(response.data.sleeve_des);
              $("#edit_sleeve_status").val(response.data.sleeve_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/sleeve/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
